...
The API-recon skill currently uses AI to orchestrate empirical probing of a black-box GET
endpoint — deciding which probes to run, in what order, and how to interpret them. The harness
